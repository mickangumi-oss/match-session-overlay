...
- 「ローカルデータ」の「消去」: このPCのログインセッション、Cookie、キャッシュを削除します。表示設定と更新元設定は残ります。
...
「APP UPDATE」の「場所」で更新用フォルダーを指定し、「確認」を押します。更新が見つかると「更新」ボタンが表示されます。
...
- 「ローカルデータ」の「消去」では、ログインセッション、Cookie、キャッシュを削除できます。表示設定と更新元設定は残ります。
