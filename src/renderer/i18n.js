...
const EN = {
  ...
  refresh: "Refresh",
  sessionRefresh: "Refresh session",
  measuring: "Measuring",
  settings: "Settings",
  ...
  mrTrend: "MR TREND",
  lpTrend: "LP TREND",
  ratingTrendHeading: "MR / LP TREND",
  historyRatingPeriod: "DISPLAY PERIOD",
  historyRatingPeriodAll: "ALL",
  historyRatingPeriodWeek: "WEEKLY",
  historyRatingDateMode: "DATE DISPLAY",
  historyRatingDatePlayed: "PLAY DAYS",
  historyRatingDateAll: "ALL DAYS",
  historyPeriodPrevious: "Previous week",
  historyPeriodNext: "Next week",
  ...
  historyFetchReady: "Ready (up to 100 matches / 10 pages, once per 10 minutes)",
  historyFetchCooldown: "Available again in {seconds}s",
  historyFetched: "Match history imported locally",
  historyFetching: "Loading…",
  historyFetchProgress: "Loading: {completed}/{max} pages · {count} fetched",
  historyFetchComplete: "Import complete: {count} matches ({pages} pages)",
  historyFetchCompleteEmpty: "Import complete: no matches",
  historyFetchPartial: "Import stopped: {count} matches ({pages} pages)",
  ...
  historyOpponentProfile: "OPPONENT PROFILE REFERENCE",
  historyOpponentMatchCharacter: "MATCH CHARACTER",
  historyOpponentMatchRating: "MATCH-TIME MR / LP",
  historyOpponentRecord: "LAST 20 BEFORE MATCH",
  historyOpponentPotentialMr: "CHARACTER POTENTIAL MR",
  historyOpponentPotentialLp: "CHARACTER POTENTIAL LP",
  historyOpponentOtherPeak: "CURRENT OTHER CHARACTER PEAK MR",
  historyOpponentRetrieved: "RETRIEVED",
  ...
  historyOpponentProfileAllHistoryScope: "Opponent profile is not requested in all-history display mode",
  historyOpponentProfileReferenceMissing: "The selected match has no valid opponent profile reference",
  historyOpponentProfileOwnerScopeMismatch: "The selected match belongs to a different history target",
  historyOpponentProfileSelectedReplayMissing: "The selected match is not present in the saved history scope",
  historyOpponentProfileDataEmpty: "The official opponent profile returned no data",
  historyOpponentProfileNotFound: "The official opponent profile was not found",
  historyOpponentProfileAuthRequired: "The official site session is unavailable; sign in again and retry",
  historyOpponentProfileRateLimited: "The official site temporarily limited this request; retry later",
  historyOpponentProfileHttpError: "The official opponent profile could not be retrieved from the official site",
  historyOpponentProfileLocaleChanged: "The profile request was cancelled because the language changed",
  historyOpponentProfileRequestFailed: "The official opponent profile request failed; retry from the selected match",
  historyOpponentProfileActScopeMissing: "The selected match's Act scope could not be verified",
  historyOpponentProfileHistoryIncomplete: "The history needed for this profile is incomplete",
  historyOpponentProfileHistoryConflict: "The saved history contains conflicting replay records",
  ...
  matchupPlayProfileAuthRequired: "Battle tendency comparison needs an official-site session",
  matchupPlayProfileRateLimited: "Battle tendency comparison was temporarily rate-limited",
  matchupPlayProfileNotFound: "The opponent's battle tendency profile was not found",
  matchupPlayProfileHttpError: "The opponent's battle tendency profile could not be retrieved",
  matchupPlayProfileRequestFailed: "The opponent's battle tendency profile request failed",
  matchupPlayComparisonPeriodMismatch: "Comparison data uses different periods and cannot be aligned",
  matchupPlayComparisonSampleMismatch: "Comparison data uses different sample sizes",
  matchupPlayComparisonScopeMismatch: "Comparison data uses different profile scopes",
  matchupPlayComparisonWindowExceeded: "Comparison data exceeds the supported 100-match window",
  matchupPlayComparisonInsufficient: "Not enough verified fields are available for comparison",
  matchupPlayComparisonDataEmpty: "No verified battle tendency fields are available",
  matchupPlayComparisonUnavailable: "Battle tendency comparison is unavailable",
  matchupPlayComparisonPartial: "Battle tendency comparison is partial; unavailable fields are shown as —",
...
const JA = {
  ...
  historyOpponentProfileAllHistoryScope: "全履歴表示では相手プロフィールを取得しません",
  historyOpponentProfileReferenceMissing: "選択試合に有効な相手プロフィール参照がありません",
  historyOpponentProfileOwnerScopeMismatch: "選択試合は別の履歴対象に属しています",
  historyOpponentProfileSelectedReplayMissing: "選択試合が保存済み履歴の対象範囲にありません",
  historyOpponentProfileDataEmpty: "公式サイトの相手プロフィールにデータがありません",
  historyOpponentProfileNotFound: "公式サイトで相手プロフィールが見つかりません",
  historyOpponentProfileAuthRequired: "公式サイトのログイン状態を確認できません。再ログインして再試行してください",
  historyOpponentProfileRateLimited: "公式サイトに一時的に制限されています。時間をおいて再試行してください",
  historyOpponentProfileHttpError: "公式サイトから相手プロフィールを取得できませんでした",
  historyOpponentProfileLocaleChanged: "言語変更によりプロフィール取得をキャンセルしました",
  historyOpponentProfileRequestFailed: "相手プロフィールの取得に失敗しました。選択試合から再試行してください",
  historyOpponentProfileActScopeMissing: "選択試合のAct範囲を確認できません",
  historyOpponentProfileHistoryIncomplete: "相手プロフィールに必要な履歴が不足しています",
  historyOpponentProfileHistoryConflict: "保存済み履歴に対戦記録の競合があります",
  ...
  matchupRefresh: "更新",
  matchupPlayProfileAuthRequired: "バトル傾向比較には公式サイトのログイン状態が必要です",
  matchupPlayProfileRateLimited: "バトル傾向比較の取得が一時的に制限されています",
  matchupPlayProfileNotFound: "相手のバトル傾向プロフィールが見つかりません",
  matchupPlayProfileHttpError: "相手のバトル傾向プロフィールを取得できませんでした",
  matchupPlayProfileRequestFailed: "相手のバトル傾向プロフィールの取得に失敗しました",
  matchupPlayComparisonPeriodMismatch: "比較データの期間が異なるため比較できません",
  matchupPlayComparisonSampleMismatch: "比較データのサンプル数が異なります",
  matchupPlayComparisonScopeMismatch: "比較データのプロフィール範囲が異なります",
  matchupPlayComparisonWindowExceeded: "比較データが対応する100試合上限を超えています",
  matchupPlayComparisonInsufficient: "比較に必要な確認済み項目が不足しています",
  matchupPlayComparisonDataEmpty: "確認済みのバトル傾向データがありません",
  matchupPlayComparisonUnavailable: "バトル傾向比較を利用できません",
  matchupPlayComparisonPartial: "バトル傾向比較は一部です。取得できない項目は—で表示します",
...
const JA_HISTORY = {
  ...
  historyRatingDateMode: "日付表示",
  historyRatingDatePlayed: "プレイ日のみ",
  historyRatingDateAll: "全日",
  historyPeriodPrevious: "前週",
  historyPeriodNext: "次週",
  ...
  replayId: "リプレイID",
  copyReplayId: "リプレイIDをコピー",
  replayIdCopied: "リプレイIDをコピーしました",
};
