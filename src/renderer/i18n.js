...
const EN = {
  ...
  historyReferenceBadge: "REFERENCE",
  historyOpponentMatchCharacter: "MATCH CHARACTER",
  historyOpponentMatchRating: "MATCH-TIME MR / LP",
  historyOpponentRecord: "LOCAL RECORD",
  historyOpponentCurrentRating: "CURRENT MR / LP",
  historyOpponentPeakRating: "PEAK MR / LP",
  historyOpponentOtherRating: "OTHER CHARACTER",
  historyOpponentOtherPeak: "OTHER CHARACTER PEAK {type}",
  historyOpponentOtherCurrent: "OTHER CHARACTER CURRENT {type}",
...
const JA = {
  ...
  historyReferenceBadge: "参考",
  historyOpponentMatchCharacter: "対戦キャラ",
  historyOpponentMatchRating: "対戦時MR / LP",
  historyOpponentRecord: "このキャラの対戦実績",
  historyOpponentCurrentRating: "現在MR / LP",
  historyOpponentPeakRating: "最高MR / LP",
  historyOpponentOtherRating: "別キャラ",
  historyOpponentOtherPeak: "別キャラの最高{type}",
  historyOpponentOtherCurrent: "別キャラの現在{type}",
