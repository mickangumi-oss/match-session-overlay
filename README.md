...
`v1.3.1`はMicrosoft Defenderで検出なし、VirusTotalで`0 / 68`（検出なし）を確認しました。SHA-256は`A765AE6512FF6BD28FCF73532FF6009BD03B6007D3219F97ACEE7E3044106C00`です。詳しくは[`v1.3.1リリースノート`](docs/release-notes/v1.3.1.md)をご覧ください。
